...
include(PATH_INCLUDES . 'social_object.php');
    ...
    $marker      = array( '{GET_HEADER}', '{IS_HOME_CLASS}', '{PATH_CSS}', '{GET_FOOTER}','{PATH_IMG}', '{PATH_JS}', '{PAGE_TITLE}', '{PAGE_KEYWORDS}', '{PAGE_DESCRIPTION}', '{PAGE_NAME}', '{SLIDER}', '{PAGE_CONTENT}', '{POSTS}', '{ONE_POST}', '{REVIEWS}', '{PATH_UPLOADS_IMG}', '{PATH_THUMB_IMG}', '{PHONE}', '{EMAIL}', '{VKONTAKTE}', '{FACEBOOK}', '{INSTAGRAMM}', '{PHOTOS}', '{VIDEOS}', '{PHOTO_GALLERY_CONTAINER}', );
