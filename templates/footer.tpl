<footer class="s_footer">
			...
			<div class="row">
				...
				<div class="footer_links">
					<div class="col-md-12">
						...
						<div class="mail footer_link"><i class="fa fa-envelope"></i><span class="span_wrapp"><a href="mailto:{EMAIL}">{EMAIL}</a></span></div>
	...
	<div class="s_copyright">
		...
		<div class="text-center unp">УНП 192639750</div>
