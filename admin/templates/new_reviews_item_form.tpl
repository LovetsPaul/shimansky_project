    ...
    <td>
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                ...
                <td width="300" align="right" class="td_button"><button name="enter_publish_review" value="{ID}">Опубликовать</button><br>
                <a class="r_del" href="new_reviews.php?del_review={ID}">Удалить</a>
                </td>
            </tr>
            <tr class="r_info">
                <td colspan="3">
